...
module RTP
  ...
  class Packet < BinData::Record
    ...
    array :csrc_ids, type: :uint32, initial_length: -> { csrc_count }
    ...
    # @return [BinData::Uint16be]
    uint16 :extension_id, onlyif: :extension?

    # @return [BinData::Uint16be]
    uint16 :extension_length, onlyif: :extension?
    ...
    string :rtp_payload, read_length: -> { bytes_remaining }
